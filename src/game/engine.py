...
class GameEngine:
    ...
    def _start_turn(self) -> tuple[dict[int, int], dict[int, int]]:
        """Initialize a new turn.

        Returns:
            Tuple of (econome_po_bonus, weapons_drawn) dicts per player.
        """
        ...
        return econome_bonuses, weapons_drawn
    ...
    def end_turn(self) -> TurnResult:
        ...
        # Start new turn
        self.state.turn += 1
        econome_bonuses, weapons_drawn = self._start_turn()
